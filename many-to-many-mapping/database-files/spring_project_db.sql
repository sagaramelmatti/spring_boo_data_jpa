...
INSERT INTO `employee` (`id`, `email`, `name`, `technical_skill`) VALUES
(1, 'sagar@gmail.com', 'sagar', 'Java');

-- --------------------------------------------------------

--
-- Table structure for table `employee_project_mapping`
--
...
INSERT INTO `employee_project_mapping` (`project_id`, `employee_id`) VALUES
(2, 1),
(3, 1);
...
--
-- Indexes for table `employee_project_mapping`
--
ALTER TABLE `employee_project_mapping`
  ADD PRIMARY KEY (`project_id`,`employee_id`),
  ADD KEY `FKkfy1wveskrkgd21usj16uc10c` (`employee_id`);
...
--
-- Constraints for table `employee_project_mapping`
--
ALTER TABLE `employee_project_mapping`
  ADD CONSTRAINT `FK25to1icblk1rg4fq9sa0rf8wd` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`),
  ADD CONSTRAINT `FKkfy1wveskrkgd21usj16uc10c` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`);
